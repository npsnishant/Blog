...
const Post = () => {
    ...
    const url = 'https://images.unsplash.com/photo-1562911791-d5677c36a51b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1887&q=80'
    return (
        <>
            <Box className={classes.conatiner}>
                ...
                <Typography className={classes.heading} style={{fontSize:'18px', fontWeight: '600'}} >Nishant Pratap SIngh</Typography>
